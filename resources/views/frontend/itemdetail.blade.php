          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <p class="card-text">
                  <input type="number" name="qty" class="form-control w-25 qty" min="1" value="1">
                </p>
                <p class="card-text"><button class="btn btn-success addToCart" data-id="{{$item->id}}" data-name="{{$item->name}}" data-photo="{{$item->photo}}" data-price="{{$item->price}}"> Add To Cart</button></p>
              </div>
            </div>
          </div>
